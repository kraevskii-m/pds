...
class CloudProvider(ABC):
    ...
    def generate_terraform(self, config: PDSConfig, env: str = "production") -> Optional[str]:
...
class PluginRegistry:
    ...
    def get_proxy(self, name: str) -> Optional[ProxyPlugin]:
        """Get proxy plugin by name."""
        return self._proxies.get(name)
    
    def get_monitoring(self, name: str) -> Optional[MonitoringPlugin]:
