...
"""
    ...
    def provision_infrastructure(
        ...
        return InfrastructureInfo(
            servers=servers,
            load_balancer_ip="64.225.100.1"
            if config.infrastructure.instances > 1
            else None,
            database_connection="postgres://user:pass@db-host:25060/db"
            if config.infrastructure.database
            else None,
            redis_connection="redis://user:pass@redis-host:25061"
    ...
    def _get_default_db_version(self, db_type: str) -> str:
        ...
        defaults = {"postgres": "15", "mysql": "8.0"}
