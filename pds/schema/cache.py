...
class SchemaCache:
    ...
    async def get_cached_resources(self, 
                                  provider: str, 
                                  ttl_hours: int = 6) -> Optional[ProviderResources]:
    ...
    async def cache_resources(self, provider: str, resources: ProviderResources) -> None:
    ...
    async def clear_cache(self, provider: Optional[str] = None) -> int:
            ...
            try:
                ...
                cache_info[provider_name] = {
                    ...
                    "instance_types_count": sum(
                        len(types) for types in 
                        cached_data["resources"].get("instance_types", {}).values()
                    )
                }
