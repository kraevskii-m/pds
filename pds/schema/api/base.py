...
class ProviderResources:
    ...
    instance_types: Dict[str, List[str]] = field(default_factory=dict)  # region -> [types]
    database_types: Dict[str, List[str]] = field(default_factory=dict)  # engine -> [versions]
    kubernetes_versions: Optional[List[str]] = None
